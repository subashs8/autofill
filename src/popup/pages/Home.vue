...
::-webkit-scrollbar-thumb {
  background:   #87E9FB !important;
  border-radius: 20px;
}

/* Handle on hover */
::-webkit-scrollbar-thumb:hover {
  background:  rgb(58, 153, 113);
  border-radius: 20px;
}
</style>
...
<template>
	...
	<div>
		<h1 class="mb-2 mt-5 text-primary-500 text-lg font-bold">Profile Info</h1>
		<div class="flex items-center mb-2">
			...
			<button  class="btn btn-green btn-icon mr-2" @click="addProfile">
  ...
  <div class="w-1/2 px-2">
			...
			<div class="flex flex-wrap -mx-2 mb-3">
				<div class="w-1/2 px-2">
					<label for="address3" class="control-label">Address</label>
...
<div class="w-full mb-3 ">
 	<label for="phoneNumber" class="control-label">Phone number</label>
			...
			<h3 class="mb-2 mt-5 text-primary-500 text-lg font-bold">Card Info</h3>
...
<div class="w-full mb-3  ">
 	<label for="cardholder-name" class="control-label">Name on Card</label>
